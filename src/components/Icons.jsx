const icon = (path, defaults = {}) => {
  const I = ({ size = defaults.size || 24, color = defaults.color || "currentColor", ...props }) => (
...
export const Icons = {
  ...
  Wind: icon(<><path d="M9.59 4.59A2 2 0 1 1 11 8H2m10.59 11.41A2 2 0 1 0 14 16H2m15.73-8.27A2.5 2.5 0 1 1 19.5 12H2"/></>),
  Leaf: icon(<><path d="M11 20A7 7 0 0 1 9.8 6.9C15.5 4.9 17 3.5 19 2c1 2 2 4.5 2 8 0 5.5-4.78 10-10 10z"/><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/></>),
  Star: icon(<><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></>),
  Sparkle: icon(<><path d="M12 2L14 9L22 9L16 14L18 22L12 17L6 22L8 14L2 9L10 9Z"/></>),
  ...
  Play: icon(<polygon points="5 3 19 12 5 21 5 3" fill="currentColor" stroke="none"/>),
